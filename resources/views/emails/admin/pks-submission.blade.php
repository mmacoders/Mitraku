...
<head>
    <meta charset="utf-8">
    <title>Pengajuan PKS Baru</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.5; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p style="font-size: 16px; line-height: 1.5; margin-bottom: 20px;">
            Ada pengajuan PKS baru yang perlu diperiksa. Berikut detailnya:
        </p>
        ...
        <div style="background-color: #f8fafc; border-radius: 8px; padding: 20px; margin-bottom: 20px; border: 1px solid #e2e8f0;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="padding: 8px 0; font-weight: 600; color: #64748b;">Judul Pengajuan:</td>
                ...
                <tr>
                    ...
                    <td style="padding: 8px 0; color: #1e293b;">{{ $pksSubmission->user->name }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; font-weight: 600; color: #64748b;">Tanggal Pengajuan:</td>
                    <td style="padding: 8px 0; color: #1e293b;">{{ $pksSubmission->created_at->format('d F Y H:i') }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; font-weight: 600; color: #64748b;">Status Awal:</td>
                    <td style="padding: 8px 0; color: #1e293b;">
                        <span style="color: #f59e0b; font-weight: 600;">Menunggu Validasi</span>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ config('app.url') }}/admin/kelola-pks" 
