            ...
            >
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            :href="isAdmin ? route('kelola.pks') : route('pks.create')"
                            :active="route().current('kelola.pks') || route().current('pks.create') || route().current('pks.show') || route().current('pks.edit')"
                        >
                            {{ isAdmin ? 'Semua PKS' : 'Pengajuan Saya' }}
                        </ResponsiveNavLink>
                    </div>
